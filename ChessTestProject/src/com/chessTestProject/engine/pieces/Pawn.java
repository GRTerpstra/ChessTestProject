...
import com.chessTestProject.engine.board.Move.PawnJump;
import com.chessTestProject.engine.board.Move.PawnMove;
import com.chessTestProject.engine.board.Move.PawnEnPassantAttackMove;
import com.chessTestProject.engine.board.Move.PawnPromotion;
...
public class Pawn extends Piece {
	...
	public Piece getPromotionPiece() {
		return new Queen(this.pieceAlliance, this.getPiecePosition(), false);
	}
}
