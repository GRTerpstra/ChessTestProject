...
public class TakenPiecesPanel extends JPanel {
	...
	private static final Dimension TAKEN_PIECES_DIMENSION = new Dimension(65, 100);
	...
	public TakenPiecesPanel() {
		...
		this.northPanel = new JPanel(new GridLayout(20, 2));
		this.southPanel = new JPanel(new GridLayout(20, 2));
